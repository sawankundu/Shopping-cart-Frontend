        ...
        <header>
            <div className='templates'>
               ...
               {/* <div className='search'>
                    <input type='text' placeholder='Search for products, styles, brands' className='header_search' />
                ...
                {/* Signin page */}
                <Link to='/signin'>
                    <AccountBoxIcon className='signin_icon'/>
                </Link>
                ...
                <Link to='/cart'>
                    ...
                    {
                        cartItems.length > 0 && (
                            <span className='basket_length'>{cartItems.length}</span>
                        )
